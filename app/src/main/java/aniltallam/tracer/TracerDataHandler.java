...
public class TracerDataHandler {
    ...
    private static final double SCALING = 3.5;
    ...
    void fillData() {
        ...
        for (double[][] points : a) {
            strokes.add(new Stroke(points, SCALING));
        }
...
//            }
            ...
            spacedPoints2(pointsArray, scale);
...
//            Point prev = null;
        ...
        void spacedPoints2(double[][] pointsArray, double scale) {
            ArrayList<Point> spacedPoints = points;
