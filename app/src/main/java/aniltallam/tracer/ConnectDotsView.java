...
public class ConnectDotsView extends View {
    ...
    public void fillPoints(){
        mPoints.clear();
        Log.d("ConnectDotsView", "width, height =>"+getWidth()+", "+getHeight());
        for(int i=30; i < this.getWidth()-30; i=i+60){
            for(int j=30; j < this.getHeight()-30; j=j+60){
    ...
    private void touch_up(float x, float y) {
        mPath.reset();
        if (isPathStarted && checkPoint(x, y, mLastPointIndex + 1)) {
